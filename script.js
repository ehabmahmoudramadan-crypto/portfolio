(function () {
  ...
  const T = {
    en: {
      ...
      "sec-experience": "07 / EXPERIENCE",
      "exp-note": "YEARS ON THE JOB",
      "exp-title-1": "Building on the",
      "exp-title-2": "web since <em class=\"accent-ink\">2024.</em>",
      "exp-track-1-range": "2024 — PRESENT",
      "exp-track-1-tag": "FRONTEND",
      "exp-item-1-title": "Frontend Developer",
      "exp-item-1-desc": "Focused on the interfaces people use — turning designs into fast, responsive and accessible web experiences.",
      "exp-track-2-range": "2025 — PRESENT",
      "exp-track-2-tag": "FULLSTACK",
      "exp-item-2-title": "Fullstack Developer",
      "exp-item-2-desc": "Expanded into the full product — frontend, backend, data and security, shipping complete systems end to end.",
      "exp-certs-title": "CERTIFICATES & TRAINING",
      "exp-cert-1": "Computer Network Fundamentals",
      "exp-cert-1-date": "FEB 2026",
      "exp-cert-2": "Introduction to Network Security",
      "exp-cert-2-date": "MAR 2026",
      "exp-cert-3": "Python Programming Basics",
      "exp-cert-3-date": "APR 2026",
      "exp-cert-4": "Implementation of Computer Network Fundamentals",
      "exp-cert-4-date": "APR 2026",
      "exp-cert-5": "Ethical Hacking",
      "exp-cert-5-date": "APR 2026",
      "exp-cert-6": "Red Hat System Administration I",
      "exp-cert-6-date": "MAY 2026",
      "sec-contact": "08 / CONTACT",
    ...
    ar: {
      ...
      "sec-experience": "07 / الخبرات",
      "exp-note": "سنوات في الميدان",
      "exp-title-1": "أبني على الويب",
      "exp-title-2": "منذ <em class=\"accent-ink\">2024.</em>",
      "exp-track-1-range": "2024 — حتى الآن",
      "exp-track-1-tag": "واجهات أمامية",
      "exp-item-1-title": "مطوّر واجهات أمامية",
      "exp-item-1-desc": "أركّز على الواجهات التي يستخدمها الناس — تحويل التصاميم إلى تجارب ويب سريعة ومتجاوبة وسهلة الوصول.",
      "exp-track-2-range": "2025 — حتى الآن",
      "exp-track-2-tag": "تطوير متكامل",
      "exp-item-2-title": "مطوّر متكامل",
      "exp-item-2-desc": "توسّعت إلى المنتج الكامل — الواجهة الأمامية والخلفية والبيانات والأمان — لإطلاق أنظمة متكاملة من البداية للنهاية.",
      "exp-certs-title": "الشهادات والتدريبات",
      "exp-cert-1": "أساسيات شبكات الكمبيوتر",
      "exp-cert-1-date": "فبراير 2026",
      "exp-cert-2": "مقدمة في أمان الشبكات",
      "exp-cert-2-date": "مارس 2026",
      "exp-cert-3": "أساسيات البرمجة بلغة بايثون",
      "exp-cert-3-date": "أبريل 2026",
      "exp-cert-4": "تنفيذ أساسيات شبكات الكمبيوتر",
      "exp-cert-4-date": "أبريل 2026",
      "exp-cert-5": "الاختراق الأخلاقي",
      "exp-cert-5-date": "أبريل 2026",
      "exp-cert-6": "إدارة أنظمة Red Hat I",
      "exp-cert-6-date": "مايو 2026",
      "sec-contact": "08 / تواصل",
